...
const QuizResult = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text style={{marginTop: vh(1)}}>
            Vui lòng chọn giá trị mà bạn cảm thấy phù hợp nhất với bản thân, với
            1 là hoàn toàn không đúng và 5 là hoàn toàn đúng.
          </Text>
      ...
      <View
        style={{ alignSelf: "center", width: vw(90) }}
      >
        <View
          style={{
            flexDirection: "row",
        ...
        >
          ...
          >
            <Text style={{ fontWeight: "bold", fontSize: 14 }}>Quay lại</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={{ fontWeight: "bold", fontSize: 14 }}>Tiếp theo</Text>
          </TouchableOpacity>
        </View>
      </View>
      </View>
